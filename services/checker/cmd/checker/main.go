...
import (
	...
	"github.com/owainjhughes/alerter/services/checker/internal/checker"
)

func main() {
	cfg := config.Load("alerter-checker")
	...
	mux.Handle("POST /", checker.NewHandler(logger, cfg.ServiceName, cfg.SinkURL))
